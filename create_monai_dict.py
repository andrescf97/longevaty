...
@hydra.main(version_base=None, config_path="./configs/", config_name="survival-torch-train.yaml")
def main(cfg):

    with open(cfg.data.dataset_file_100, "r") as fp:
        ds_100 = json.load(fp)

    train_dataset = create_dataset(ds_100, "train", cfg.data.use_thinnest_cut,
