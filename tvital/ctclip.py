...
class AlibiPositionalBias(nn.Module):
    ...
    def forward(self, sim, device="cpu"):
...
def gradient_penalty(images, output, weight = 10, device="cpu"):
...
def pick_video_frame(video, frame_indices, device="cpu"):
...
class CTViT(nn.Module):
    ...
    def copy_for_eval(self, device="cpu"):
