...
def create_ct_rate_dataset(split):
    ...
    dataset = []
    nifti_root = os.path.join('/pool/data/lung/CT-RATE/dataset/', split)
...
def main(cfg):
    ...
    ct_rate = create_ct_rate_dataset(split="train_fixed")
