...
def get_thinnest_cut(exam_dict, data_root):
    def check_annotation(pid, study_id, series_id):
        return os.path.exists(os.path.join(data_root, "annotations", pid, study_id, series_id, f"{series_id}.npy"))
...
def get_volume_dict(
    ...
    #     annotation_path = os.path.join("/vol/cuttlefish/users/braj/nlst_npy", "new_annos", patient_id, study_id, ses_id, f"{ses_id}.npy")
    #     img_path = os.path.join("/vol/cuttlefish/users/braj/nlst_npy", "new_annos_img", patient_id, study_id, ses_id, f"{ses_id}.npy")
    #     mask_path = os.path.join("/vol/cuttlefish/users/braj/nlst_npy", "new_annos_mask", patient_id, study_id, ses_id, f"{ses_id}.npy")
